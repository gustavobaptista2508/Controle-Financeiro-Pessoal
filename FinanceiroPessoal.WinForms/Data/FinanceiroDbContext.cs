...
namespace FinanceiroPessoal.WinForms.Data
{
    public class FinanceiroDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Lancamento>().HasQueryFilter(x => x.UsuarioId == FinanceiroPessoal.WinForms.Services.SessaoUsuario.UsuarioId);
            modelBuilder.Entity<Categoria>().HasQueryFilter(x => x.UsuarioId == FinanceiroPessoal.WinForms.Services.SessaoUsuario.UsuarioId);
            modelBuilder.Entity<Conta>().HasQueryFilter(x => x.UsuarioId == FinanceiroPessoal.WinForms.Services.SessaoUsuario.UsuarioId);
            modelBuilder.Entity<Pessoa>().HasQueryFilter(x => x.UsuarioId == FinanceiroPessoal.WinForms.Services.SessaoUsuario.UsuarioId);
        }
        ...
        {
            var usuarioId = FinanceiroPessoal.WinForms.Services.SessaoUsuario.UsuarioId;
